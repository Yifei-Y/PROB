...
from os_engine import evaluate, train_one_epoch, get_exemplar_replay
...
def main(args):
    if len(args.wandb_project)>0:
        if len(args.wandb_name)>0:
            wandb.init(project=args.wandb_project, entity="yfyang", group=args.wandb_name)
        else:
            wandb.init(project=args.wandb_project, entity="yfyang")
        wandb.config = args
    #else:
    #    wandb=None
